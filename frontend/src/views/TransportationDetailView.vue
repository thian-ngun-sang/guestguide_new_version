  ...
  export default defineComponent({
    ...
    computed: {
      ...
      serviceImageUrl(){
        ...
        return mediaPrefixer.getUrl(this.service.files[0], 'transportation')
      },
    },
    methods: {
      toggleBookmark(){
        if(!this.service?._meta.bookmarked?._id){
          createBookmark({ entityId: this.service._id, entityType: "transportation" })
            .then(res => {
